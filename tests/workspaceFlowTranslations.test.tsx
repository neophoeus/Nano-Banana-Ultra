...
const phaseEGroup3ShellParityKeys = [
    ...
    'editorErrorRetry',
    'editorErrorReturn',
    'editorTextInputPlaceholder',
    'editorTextInputHintPrimary',
    'editorTextInputHintSecondary',
    'editorTextToolHintTitle',
    'editorTextToolHintBody',
    'editorTextFirstUseTitle',
    'editorTextFirstUseBody',
    'editorTextFirstUseConfirm',
    'btnRender',
    'btnReset',
    'btnFit',
    'btnFill',
