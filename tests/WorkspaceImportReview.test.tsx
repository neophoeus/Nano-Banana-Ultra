...
describe('WorkspaceImportReview', () => {
    it('renders branch preview cards as disclosure shells with prompt previews', () => {
        ...
        expect(markup).toContain('Choose Next Route');
        expect(markup).toContain('Replace first, then choose where this imported source should continue.');
        expect(markup).toContain('History Route');
        expect(markup).toContain('Keep browsing this imported chain in history.');
        expect(markup).toContain('Active Route');
        expect(markup).toContain('Promote this imported turn into the next working source.');
        ...
        expect(markup).toContain('Open latest in history');
        expect(markup).toContain('Continue latest turn');
        expect(markup).toContain('Branch from latest source');
    ...
    it('renders the direct replace path as a disclosure shell with preview-first copy', () => {
        ...
        expect(markup).toContain('Replace + Open latest in history');
        expect(markup).toContain('Replace + Continue latest turn');
        expect(markup).toContain('Replace + Branch from latest source');
    });
});
