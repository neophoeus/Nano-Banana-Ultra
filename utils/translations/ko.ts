export const ko = {
    ...
    statusPanelSystem: '시스템',
    statusPanelTitle: '상태 패널',
    statusPanelRefresh: '시스템 상태 새로고침',
    statusPanelLocalApi: '로컬 API',
    statusPanelGeminiKey: 'Gemini 키',
    statusPanelLastCheck: '마지막 확인',
    statusPanelChecking: '확인 중',
    statusPanelPingingRoute: '로컬 경로 확인 중',
    statusPanelOffline: '오프라인',
    statusPanelRouteUnavailable: '경로를 사용할 수 없음',
    statusPanelLive: '정상',
    statusPanelApiResponding: '로컬 API 응답 중',
    statusPanelReadingConfig: '런타임 구성을 읽는 중',
    statusPanelReady: '준비 완료',
    statusPanelKeyDetected: 'Gemini 키 감지됨',
    statusPanelMissing: '없음',
    statusPanelSetKey: 'GEMINI_API_KEY 설정',
    statusPanelExpand: '펼치기',
    statusPanelCollapse: '접기',
    statusPanelNever: '없음',
    statusPanelUnknown: '알 수 없음',
    ...
    workspacePanelResponseEyebrow: '응답',
    ...
    sessionReplayEyebrow: '세션 재생',
    sessionReplayTitle: '이 워크스페이스에 저장된 워크플로 타임라인을 재생합니다.',
    sessionReplayDesc:
        '재생 중에도 중앙 스테이지 화면은 유지되며, 워크스페이스 스냅샷과 함께 저장된 전체 워크플로 로그를 검토할 수 있습니다.',
    sessionReplayEvents: '이벤트',
    sessionReplayStages: '스테이지',
    sessionReplayHistorySteps: '기록 단계',
    sessionReplayErrors: '오류',
    sessionReplayFocus: '재생 포커스',
    sessionReplayPrev: '이전',
    sessionReplayNext: '다음',
    sessionReplayCurrentStageSource: '현재 스테이지 소스',
    sessionReplayStepCounter: '단계 {0} / {1}',
    ...
    sessionReplayNoTimestamp: '기록된 시간 없음',
    sessionReplayEmpty: '이 워크스페이스에는 아직 워크플로 항목이 기록되지 않았습니다.',
    sessionReplayTimeline: '재생 타임라인',
    sessionReplayJumpToSource: '소스 이벤트로 이동',
    sessionReplayJumpToLatest: '최신으로 이동',
    sessionReplayNoTime: '시간 없음',
    sessionReplayLabelSystem: '시스템',
    sessionReplayLabelInput: '입력',
    sessionReplayLabelRequest: '요청',
    sessionReplayLabelProcessing: '처리 중',
    sessionReplayLabelOutput: '출력',
    sessionReplayLabelHistory: '기록',
    sessionReplayLabelError: '오류',
    sessionReplayLabelCancelled: '취소됨',
