export const ko = {
    ...
    generationFailureDetailThoughtsOnly: 'thought summaries 만 반환되었고 이미지 바이트는 생성되지 않았습니다.',
    generationFailureDetailMissingCandidates: '모델이 response candidates를 반환하지 않았습니다.',
    generationFailureDetailMissingParts: 'candidate 는 반환되었지만 content parts 가 비어 있었습니다.',
