export const ko = {
    ...
    promptThinkingLevel: '프롬프트 생각 레벨',
    promptThinkingLevelLow: '낮음',
    promptThinkingLevelMedium: '중간',
    promptThinkingLevelHigh: '높음',
    promptThinkingLevelLowTooltip: '⚡ 낮음 (Low): 빠른 응답 속도 및 최소 토큰 소모',
    promptThinkingLevelMediumTooltip: '🧠 중간 (Med): 표준 추론 및 균형 잡힌 창의성',
    promptThinkingLevelHighTooltip: '🔬 높음 (High): 심층 디테일 분석 및 장문 추론',
    ...
    composerSendIntentSetBatchToOne: '수량을 1로 변경',
    composerSendIntentCancel: '취소',
    ...
    statusPanelGeminiKey: 'API 키',
    statusPanelDirectMode: 'AI Studio',
    executionModeTitle: '실행 엔진 모드',
    executionModeAuto: '자동 감지',
    executionModeLocal: '로컬 API 실행',
    executionModeDirect: 'AI Studio 실행',
    executionModeSelectorTooltip: '실행 엔진 모드 전환 (자동 / 로컬 API 실행 / AI Studio 실행)',
    aiStudioTierTitle: 'Google AI 플랜',
    aiStudioTierPro: 'Google AI Pro (1x)',
    aiStudioTierUltra5x: 'Google AI Ultra (5x)',
    aiStudioTierUltra20x: 'Google AI Ultra (20x)',
    aiStudioTierSelectorTooltip: '최적화된 생성 속도 및 속도 제한 방지를 위한 Google AI 구독 플랜 선택',
    rateLimitModalTitle: 'API 호출 빈도 제한 도달',
    rateLimitModalDesc: '분당 요청 빈도(IPM / RPM 429) 한도에 도달했습니다. 보호를 위해 자동 일시 중지되었으며, 대기 시간이 끝나면 자동으로 재시도합니다.',
    rateLimitCountdownLabel: '남은 대기 시간',
    rateLimitSecondsUnit: '초',
    rateLimitRetryBadge: '자동 재시도 {current} / {max}',
    rateLimitActionWait: '계속 대기',
    rateLimitActionCancel: '생성 취소',
    debugTerminalOpen: '진단 터미널 열기',
    debugTerminalClose: '닫기',
    debugTerminalEyebrow: '숨겨진 진단 표면',
    debugTerminalTitle: '진단 터미널',
    debugTerminalDescription:
        'API 키나 원본 이미지 바이트를 노출하지 않고 정리된 요청, 응답, 스트림 이벤트, 재시도, 배치 흐름, 워크스페이스 저장 상태, 상관 진단을 확인합니다.',
    debugTerminalEventCount: '총 {0}개 이벤트',
    debugTerminalFilteredCount: '{0}개 표시',
    debugTerminalClear: '지우기',
    ...
    debugTerminalEmpty:
        '아직 진단 이벤트가 없습니다. 생성, 프롬프트 도구, 배치 흐름 또는 워크스페이스 작업을 실행하면 정리된 추적이 쌓이기 시작합니다.',
    ...
    debugTerminalSourceAll: '모든 소스',
    debugTerminalRouteAll: '모든 경로',
    debugTerminalSearchPlaceholder: '경로, 요약, 상태, 상관관계, payload 검색...',
    debugTerminalFocusCorrelation: '상관관계 집중',
    debugTerminalCorrelationActive: '상관관계: {0}',
    debugTerminalSourceGeneration: '생성',
    debugTerminalSourcePromptTools: '프롬프트 도구',
    debugTerminalSourceBatch: '배치',
    debugTerminalSourceWorkspace: '워크스페이스',
    debugTerminalSourceRuntime: '런타임',
    debugTerminalSourceImageFile: '이미지/파일',
    debugTerminalSourceBackend: '백엔드',
    debugTerminalSourceWorkflow: '워크플로',
    debugTerminalSourceUnknown: '알 수 없음',
    statusPanelLive: '정상',
    ...
    workspaceToolbarGroupLabel: '워크스페이스',
    workspaceToolbarActionImport: '가져오기',
    workspaceToolbarActionExport: '내보내기',
    workspaceToolbarActionClear: '지우기',
