export const ko = {
    ...
    promptLabel: '프롬프트',
    composerPromptLabelIndependent: '제작 지시',
    composerPromptLabelMemory: 'Dialogue',
    composerPromptPlaceholderIndependent: '이번에 생성하거나 수정할 내용을 설명해 주세요...',
    composerPromptPlaceholderMemory: '이전 Dialogue를 이어서 이번 차례를 어떻게 조정할지 알려 주세요...',
