export const ja = {
    ...
    generationFailureDetailThoughtsOnly: 'thought summaries だけが返され、画像データは出力されませんでした。',
    generationFailureDetailMissingCandidates: 'モデルから応答 candidate が返されませんでした。',
    generationFailureDetailMissingParts: 'candidate は返されましたが、content parts が含まれていませんでした。',
