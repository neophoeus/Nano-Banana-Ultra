export const ja = {
    ...
    promptThinkingLevel: 'プロンプト思考レベル',
    promptThinkingLevelLow: '低',
    promptThinkingLevelMedium: '中',
    promptThinkingLevelHigh: '高',
    promptThinkingLevelLowTooltip: '⚡ 低 (Low): 高速レスポンス・低トークン消費',
    promptThinkingLevelMediumTooltip: '🧠 中 (Med): 標準的な推論・バランス重視',
    promptThinkingLevelHighTooltip: '🔬 高 (High): 詳細な分析・長文思考',
    groundingModeOff: 'オフ',
    ...
    statusPanelGeminiKey: 'API キー',
    statusPanelDirectMode: 'AI Studio',
    executionModeTitle: '実行エンジンモード',
    executionModeAuto: '自動検出',
    executionModeLocal: 'ローカル API 実行',
    executionModeDirect: 'AI Studio 実行',
    executionModeSelectorTooltip: '実行エンジンモード切り替え (自動 / ローカル API 実行 / AI Studio 実行)',
    aiStudioTierTitle: 'Google AI プラン',
    aiStudioTierPro: 'Google AI Pro (1x)',
    aiStudioTierUltra5x: 'Google AI Ultra (5x)',
    aiStudioTierUltra20x: 'Google AI Ultra (20x)',
    aiStudioTierSelectorTooltip: 'Google AI サブスクリプションプランを選択して生成ペースを最適化',
    rateLimitModalTitle: 'API呼び出し頻度制限に達しました',
    rateLimitModalDesc: '1分あたりのリクエスト頻度（IPM / RPM 429）上限に達しました。保護のため自動一時停止しており、クールダウン完了後に自動再試行します。',
    rateLimitCountdownLabel: '残り待機時間',
    rateLimitSecondsUnit: '秒',
    rateLimitRetryBadge: '自動再試行 {current} / {max}',
    rateLimitActionWait: '待機を続ける',
    rateLimitActionCancel: '生成をキャンセル',
    debugTerminalOpen: '診断ターミナルを開く',
    debugTerminalClose: '閉じる',
    debugTerminalEyebrow: '隠し診断サーフェス',
    debugTerminalTitle: '診断ターミナル',
    debugTerminalDescription:
        'API キーや生の画像バイトを露出させずに、サニタイズ済みのリクエスト、レスポンス、ストリームイベント、再試行、バッチ処理、ワークスペース永続化、関連診断を確認します。',
    debugTerminalEventCount: '{0} 件のイベント',
    debugTerminalFilteredCount: '{0} 件を表示',
    debugTerminalClear: 'クリア',
    debugTerminalExport: 'JSON をエクスポート',
    debugTerminalCopySelected: '選択項目をコピー',
    debugTerminalAutoScrollOn: '自動スクロール有効',
    debugTerminalAutoScrollOff: '自動スクロール無効',
    debugTerminalEmpty:
        '診断イベントはまだありません。生成、プロンプトツール、バッチ処理、またはワークスペース操作を使うと、サニタイズ済みトレースの収集が始まります。',
    ...
    debugTerminalSourceAll: 'すべてのソース',
    debugTerminalRouteAll: 'すべてのルート',
    debugTerminalSearchPlaceholder: 'ルート、要約、状態、相関、payload を検索...',
    debugTerminalFocusCorrelation: '相関に絞り込む',
    debugTerminalCorrelationActive: '相関: {0}',
    debugTerminalSourceGeneration: '生成',
    debugTerminalSourcePromptTools: 'プロンプトツール',
    debugTerminalSourceBatch: 'バッチ',
    debugTerminalSourceWorkspace: 'ワークスペース',
    debugTerminalSourceRuntime: 'ランタイム',
    debugTerminalSourceImageFile: '画像/ファイル',
    debugTerminalSourceBackend: 'バックエンド',
    debugTerminalSourceWorkflow: 'ワークフロー',
    debugTerminalSourceUnknown: '不明',
    statusPanelLive: '稼働中',
    ...
    workspaceToolbarGroupLabel: 'ワークスペース',
    workspaceToolbarActionImport: '読み込み',
    workspaceToolbarActionExport: '書き出し',
    workspaceToolbarActionClear: 'クリア',
    ...
    generationFailureDetailQuota:
        'リクエストがレート制限されたか、一時的にクォータが枯渇しました。リクエストの間隔を空けるか、ローリングウィンドウのリセットをお待ちください。',
} as const;
