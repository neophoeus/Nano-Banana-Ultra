export const fr = {
    ...
    promptThinkingLevel: 'Niveau de réflexion du prompt',
    promptThinkingLevelLow: 'Faible',
    promptThinkingLevelMedium: 'Moyen',
    promptThinkingLevelHigh: 'Élevé',
    promptThinkingLevelLowTooltip: '⚡ Faible (Low): Réponse ultra-rapide, consommation minimale de tokens',
    promptThinkingLevelMediumTooltip: '🧠 Moyen (Med): Raisonnement standard, créativité équilibrée',
    promptThinkingLevelHighTooltip: '🔬 Élevé (High): Analyse détaillée approfondie',
    ...
    autoExportNotificationText:
        'Sauvegarde automatique : {0} images ont été générées ou la limite de {1} Mo a été atteinte. Le fichier a été sauvegardé dans Téléchargements.',
    ...
    composerSendIntentSetBatchToOne: 'Changer la quantité à 1',
    composerSendIntentCancel: 'Annuler',
    ...
    statusPanelGeminiKey: 'Clé API',
    statusPanelDirectMode: 'AI Studio',
    executionModeTitle: 'Mode moteur',
    executionModeAuto: 'Détection auto',
    executionModeLocal: 'API locale',
    executionModeDirect: 'AI Studio',
    executionModeSelectorTooltip: 'Changer le mode du moteur (Auto / API locale / AI Studio)',
    aiStudioTierTitle: 'Forfait Google AI',
    aiStudioTierPro: 'Google AI Pro (1x)',
    aiStudioTierUltra5x: 'Google AI Ultra (5x)',
    aiStudioTierUltra20x: 'Google AI Ultra (20x)',
    aiStudioTierSelectorTooltip: 'Sélectionner le forfait Google AI pour optimiser le rythme de génération',
    rateLimitModalTitle: 'Limite de requêtes API atteinte',
    rateLimitModalDesc: 'Le quota par minute (IPM / RPM 429) a été atteint. Le système a été mis en pause et réessaiera à la fin du délai.',
    rateLimitCountdownLabel: "Temps d'attente restant",
    rateLimitSecondsUnit: 's',
    rateLimitRetryBadge: 'Nouvelle tentative automatique {current} sur {max}',
    rateLimitActionWait: "Continuer d'attendre",
    rateLimitActionCancel: 'Annuler la génération',
    debugTerminalOpen: 'Ouvrir le terminal de diagnostic',
    debugTerminalClose: 'Fermer',
    debugTerminalEyebrow: 'Surface de diagnostic cachée',
    debugTerminalTitle: 'Terminal de diagnostic',
    debugTerminalDescription:
        'Inspectez les requêtes, réponses, événements de flux, reprises, workflows par lot, persistance de l’espace de travail et diagnostics corrélés nettoyés sans exposer les clés API ni les octets d’image bruts.',
    debugTerminalEventCount: '{0} événements au total',
    debugTerminalFilteredCount: '{0} visibles',
    debugTerminalClear: 'Effacer',
    debugTerminalExport: 'Exporter JSON',
    debugTerminalCopySelected: 'Copier la sélection',
    debugTerminalAutoScrollOn: 'Défilement auto actif',
    debugTerminalAutoScrollOff: 'Défilement auto inactif',
    debugTerminalEmpty:
        'Aucun événement de diagnostic pour l’instant. Lancez une génération, un outil de prompt, un workflow par lot ou une action d’espace de travail pour commencer à capturer des traces nettoyées.',
    debugTerminalSelectEvent: 'Sélectionnez un événement pour inspecter son payload nettoyé.',
    debugTerminalFilterAll: 'Tous',
    debugTerminalFilterRequest: 'Requête',
    debugTerminalFilterResponse: 'Réponse',
    debugTerminalFilterError: 'Erreur',
    debugTerminalFilterStream: 'Flux',
    debugTerminalFilterRetry: 'Réessai',
    debugTerminalFilterLog: 'Journal',
    debugTerminalSourceAll: 'Toutes les sources',
    debugTerminalRouteAll: 'Toutes les routes',
    debugTerminalSearchPlaceholder: 'Rechercher route, résumé, statut, corrélation, payload...',
    debugTerminalFocusCorrelation: 'Cibler la corrélation',
    debugTerminalCorrelationActive: 'Corrélation : {0}',
    debugTerminalSourceGeneration: 'Génération',
    debugTerminalSourcePromptTools: 'Outils de prompt',
    debugTerminalSourceBatch: 'Lot',
    debugTerminalSourceWorkspace: 'Espace de travail',
    debugTerminalSourceRuntime: 'Exécution',
    debugTerminalSourceImageFile: 'Image/Fichier',
    debugTerminalSourceBackend: 'Backend',
    debugTerminalSourceWorkflow: 'Workflow',
    debugTerminalSourceUnknown: 'Inconnu',
    ...
    workspaceIncreaseFontSize: 'Agrandir la taille de police',
    workspaceDecreaseFontSize: 'Réduire la taille de police',
    workspaceResetFontSize: 'Réinitialiser la taille de police',
    ...
    workspaceToolbarGroupLabel: 'Espace',
    workspaceToolbarActionImport: 'Importer',
    workspaceToolbarActionExport: 'Exporter',
    workspaceToolbarActionClear: 'Effacer',
