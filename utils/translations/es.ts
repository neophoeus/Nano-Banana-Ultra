export const es = {
    ...
    queuedBatchJobsRetryImport: 'Reintentar importacion',
    queuedBatchJobsRetryImportHint:
        'La importacion anterior no encontro imagenes utilizables. Reintenta solo si quieres revisar el lote otra vez con el importador actual.',
    queuedBatchJobsImportUnavailable: 'Importacion no disponible',
    queuedBatchJobsClear: 'Borrar',
    queuedBatchJobsClearIssuesAction: 'Borrar no importables',
    queuedBatchJobsClearImportedAction: 'Borrar importados',
    queuedBatchJobsMonitorGroup: 'Seguimiento',
    queuedBatchJobsResultsGroup: 'Resultados',
    queuedBatchJobsCleanupGroup: 'Limpieza',
    queuedBatchClearIssuesNotice: 'Se borraron {0} trabajos por lotes no importables.',
    queuedBatchClearImportedNotice: 'Se borraron {0} trabajos por lotes ya importados.',
    queuedBatchClearIssuesLog: 'Se borraron {0} trabajos por lotes no importables de la cola local.',
    queuedBatchClearImportedLog: 'Se borraron {0} trabajos por lotes ya importados de la cola local.',
    ...
    queuedBatchNoPayloadResultsNotice:
        'Este trabajo por lotes termino sin ningun contenido de imagen en linea que se pudiera importar.',
