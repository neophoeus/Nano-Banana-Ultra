export const es = {
    ...
    statusPanelSystem: 'Sistema',
    statusPanelTitle: 'Panel de estado',
    statusPanelRefresh: 'Actualizar estado del sistema',
    statusPanelLocalApi: 'API local',
    statusPanelGeminiKey: 'Clave Gemini',
    statusPanelLastCheck: 'Última revisión',
    statusPanelChecking: 'Comprobando',
    statusPanelPingingRoute: 'Consultando la ruta local',
    statusPanelOffline: 'Sin conexión',
    statusPanelRouteUnavailable: 'Ruta no disponible',
    statusPanelLive: 'Activo',
    statusPanelApiResponding: 'La API local responde correctamente',
    statusPanelReadingConfig: 'Leyendo la configuracion de ejecucion',
    statusPanelReady: 'Listo',
    statusPanelKeyDetected: 'Clave Gemini detectada',
    statusPanelMissing: 'Falta',
    statusPanelSetKey: 'Configura GEMINI_API_KEY',
    statusPanelExpand: 'Expandir',
    statusPanelCollapse: 'Contraer',
    statusPanelNever: 'Nunca',
    statusPanelUnknown: 'Desconocido',
    ...
    workspaceRestoreActiveBranch: 'rama activa {0}',
    ...
    workspaceRestoreDismiss: 'Cerrar',
    ...
    workspaceViewerContinueEditing: 'Continuar editando',
    workspaceViewerUploadBaseToEdit: 'Subir base para editar',
    ...
    sessionReplayErrors: 'Errores',
    sessionReplayFocus: 'Foco de repeticion',
    sessionReplayPrev: 'Anterior',
    sessionReplayNext: 'Siguiente',
    sessionReplayCurrentStageSource: 'Origen actual de la escena',
    sessionReplayStepCounter: 'Paso {0} / {1}',
    ...
    sessionReplayNoTimestamp: 'Sin marca de tiempo',
    ...
    sessionReplayJumpToSource: 'Ir al evento de origen',
    sessionReplayJumpToLatest: 'Ir al ultimo',
    sessionReplayNoTime: 'Sin hora',
    sessionReplayLabelSystem: 'Sistema',
    sessionReplayLabelInput: 'Entrada',
    sessionReplayLabelRequest: 'Solicitud',
    sessionReplayLabelProcessing: 'Procesando',
    sessionReplayLabelOutput: 'Salida',
    sessionReplayLabelHistory: 'Historial',
    sessionReplayLabelError: 'Error',
    sessionReplayLabelCancelled: 'Cancelado',
