export const es = {
    ...
    promptThinkingLevel: 'Nivel de pensamiento del prompt',
    promptThinkingLevelLow: 'Bajo',
    promptThinkingLevelMedium: 'Medio',
    promptThinkingLevelHigh: 'Alto',
    promptThinkingLevelLowTooltip: '⚡ Bajo (Low): Respuesta ultrarrápida, menor coste de tokens',
    promptThinkingLevelMediumTooltip: '🧠 Medio (Med): Razonamiento estándar, creatividad equilibrada',
    promptThinkingLevelHighTooltip: '🔬 Alto (High): Análisis forense profundo y detallado',
    ...
    statusPanelGeminiKey: 'Clave API',
    statusPanelDirectMode: 'AI Studio',
    executionModeTitle: 'Modo del motor',
    executionModeAuto: 'Detección automática',
    executionModeLocal: 'API local',
    executionModeDirect: 'AI Studio',
    executionModeSelectorTooltip: 'Cambiar modo de motor de ejecución (Automático / API local / AI Studio)',
    aiStudioTierTitle: 'Plan Google AI',
    aiStudioTierPro: 'Google AI Pro (1x)',
    aiStudioTierUltra5x: 'Google AI Ultra (5x)',
    aiStudioTierUltra20x: 'Google AI Ultra (20x)',
    aiStudioTierSelectorTooltip: 'Seleccionar plan Google AI para optimizar el ritmo de generación',
    rateLimitModalTitle: 'Límite de frecuencia de API alcanzado',
    rateLimitModalDesc: 'Se ha alcanzado el límite por minuto (IPM / RPM 429). El sistema se ha pausado automáticamente y reintentará tras el enfriamiento.',
    rateLimitCountdownLabel: 'Tiempo de espera restante',
    rateLimitSecondsUnit: 's',
    rateLimitRetryBadge: 'Reintento automático {current} de {max}',
    rateLimitActionWait: 'Continuar esperando',
    rateLimitActionCancel: 'Cancelar generación',
    debugTerminalOpen: 'Abrir terminal de diagnóstico',
    debugTerminalClose: 'Cerrar',
    debugTerminalEyebrow: 'Superficie de diagnóstico oculta',
    debugTerminalTitle: 'Terminal de diagnóstico',
    debugTerminalDescription:
        'Inspecciona solicitudes, respuestas, eventos de stream, reintentos, flujos por lotes, persistencia del espacio de trabajo y diagnósticos correlacionados saneados sin exponer claves API ni bytes de imagen sin procesar.',
    debugTerminalEventCount: '{0} eventos en total',
    debugTerminalFilteredCount: '{0} visibles',
    debugTerminalClear: 'Limpiar',
    ...
    debugTerminalEmpty:
        'Aun no hay eventos de diagnostico. Ejecuta una generacion, una herramienta de prompt, un flujo por lotes o una accion del espacio de trabajo para empezar a capturar trazas saneadas.',
    ...
    debugTerminalSourceAll: 'Todas las fuentes',
    debugTerminalRouteAll: 'Todas las rutas',
    debugTerminalSearchPlaceholder: 'Buscar ruta, resumen, estado, correlacion, payload...',
    debugTerminalFocusCorrelation: 'Enfocar correlacion',
    debugTerminalCorrelationActive: 'Correlacion: {0}',
    debugTerminalSourceGeneration: 'Generacion',
    debugTerminalSourcePromptTools: 'Herramientas de prompt',
    debugTerminalSourceBatch: 'Lote',
    debugTerminalSourceWorkspace: 'Espacio de trabajo',
    debugTerminalSourceRuntime: 'Ejecucion',
    debugTerminalSourceImageFile: 'Imagen/Archivo',
    debugTerminalSourceBackend: 'Backend',
    debugTerminalSourceWorkflow: 'Flujo de trabajo',
    debugTerminalSourceUnknown: 'Desconocido',
    ...
    workspaceToolbarGroupLabel: 'Espacio',
    workspaceToolbarActionImport: 'Importar',
    workspaceToolbarActionExport: 'Exportar',
    workspaceToolbarActionClear: 'Borrar',
    ...
    generationFailureDetailQuota:
        'La solicitud fue limitada por velocidad o su cuota se agotó temporalmente. Ampliar el intervalo entre solicitudes o esperar a que se restablezca la ventana móvil puede ayudar.',
} as const;
