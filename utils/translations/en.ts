export const en = {
    ...
    promptThinkingLevel: 'Prompt Thinking Level',
    promptThinkingLevelLow: 'Low',
    promptThinkingLevelMedium: 'Med',
    promptThinkingLevelHigh: 'High',
    promptThinkingLevelLowTooltip: '⚡ Low: Sub-second fast response, lowest token cost',
    promptThinkingLevelMediumTooltip: '🧠 Med: Standard reasoning, balanced creativity',
    promptThinkingLevelHighTooltip: '🔬 High: Deep forensic detail extraction & long analysis',
    ...
    statusPanelGeminiKey: 'API Key',
    statusPanelDirectMode: 'AI Studio',
    executionModeTitle: 'Engine Mode',
    executionModeAuto: 'Auto Detect',
    executionModeLocal: 'Local API',
    executionModeDirect: 'AI Studio',
    executionModeSelectorTooltip: 'Switch Execution Engine Mode (Auto / Local API / AI Studio)',
    aiStudioTierTitle: 'Google AI Plan',
    aiStudioTierPro: 'Google AI Pro (1x)',
    aiStudioTierUltra5x: 'Google AI Ultra (5x)',
    aiStudioTierUltra20x: 'Google AI Ultra (20x)',
    aiStudioTierSelectorTooltip: 'Select Google AI subscription plan for optimized generation pacing',
    rateLimitModalTitle: 'API Rate Limit Reached',
    rateLimitModalDesc: 'The requests-per-minute quota (IPM / RPM 429) has been reached. The system has automatically paused and will retry once the cooldown expires.',
    rateLimitCountdownLabel: 'Cooldown Time Remaining',
    rateLimitSecondsUnit: 's',
    rateLimitRetryBadge: 'Auto-retry {current} of {max}',
    rateLimitActionWait: 'Continue Waiting',
    rateLimitActionCancel: 'Cancel Generation',
    debugTerminalOpen: 'Open diagnostics terminal',
    debugTerminalClose: 'Close',
    debugTerminalEyebrow: 'Hidden diagnostics surface',
    debugTerminalTitle: 'Diagnostics Terminal',
    debugTerminalDescription:
        'Inspect sanitized requests, responses, stream events, retries, batch workflows, workspace persistence, and correlated diagnostics without exposing API keys or raw image bytes.',
    ...
    debugTerminalEmpty:
        'No diagnostic events yet. Use generation, prompt tools, batch workflows, or workspace actions to start capturing sanitized traces.',
    ...
    debugTerminalSourceAll: 'All sources',
    debugTerminalRouteAll: 'All routes',
    debugTerminalSearchPlaceholder: 'Search route, summary, status, correlation, payload...',
    debugTerminalFocusCorrelation: 'Focus Correlation',
    debugTerminalCorrelationActive: 'Correlation: {0}',
    debugTerminalSourceGeneration: 'Generation',
    debugTerminalSourcePromptTools: 'Prompt Tools',
    debugTerminalSourceBatch: 'Batch',
    debugTerminalSourceWorkspace: 'Workspace',
    debugTerminalSourceRuntime: 'Runtime',
    debugTerminalSourceImageFile: 'Image/File',
    debugTerminalSourceBackend: 'Backend',
    debugTerminalSourceWorkflow: 'Workflow',
    debugTerminalSourceUnknown: 'Unknown',
    ...
    generationFailureDetailQuota:
        'The request was rate-limited or your quota has been temporarily exhausted. Spacing out requests or waiting for the rolling window to reset may help.',
    ...
    workspaceIncreaseFontSize: 'Increase font size',
    workspaceDecreaseFontSize: 'Decrease font size',
    workspaceResetFontSize: 'Reset font size',
    ...
    workspaceToolbarGroupLabel: 'Workspace',
    workspaceToolbarActionImport: 'Import',
    workspaceToolbarActionExport: 'Export',
    workspaceToolbarActionClear: 'Clear',
    ...
    composerQueueBatchFollowUpJob: 'Add stage image to queue',
