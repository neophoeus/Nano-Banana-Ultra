export const en = {
    ...
    generationFailureDetailThoughtsOnly: 'Only thought summaries were returned, but no image bytes were emitted.',
    generationFailureDetailMissingCandidates: 'No response candidates were returned by the model.',
    generationFailureDetailMissingParts: 'A response candidate was returned, but it contained no content parts.',
