export const ru = {
    ...
    promptThinkingLevel: 'Уровень рассуждений промпта',
    promptThinkingLevelLow: 'Низкий',
    promptThinkingLevelMedium: 'Средний',
    promptThinkingLevelHigh: 'Высокий',
    promptThinkingLevelLowTooltip: '⚡ Низкий (Low): Быстрый ответ, минимальный расход токенов',
    promptThinkingLevelMediumTooltip: '🧠 Средний (Med): Стандартное рассуждение, баланс креативности',
    promptThinkingLevelHighTooltip: '🔬 Высокий (High): Глубокий анализ деталей',
    ...
    statusPanelGeminiKey: 'API-ключ',
    statusPanelDirectMode: 'AI Studio',
    executionModeTitle: 'Режим движка',
    executionModeAuto: 'Автовыбор',
    executionModeLocal: 'Локальный API',
    executionModeDirect: 'AI Studio',
    executionModeSelectorTooltip: 'Переключение режима движка (Авто / Локальный API / AI Studio)',
    aiStudioTierTitle: 'Тариф Google AI',
    aiStudioTierPro: 'Google AI Pro (1x)',
    aiStudioTierUltra5x: 'Google AI Ultra (5x)',
    aiStudioTierUltra20x: 'Google AI Ultra (20x)',
    aiStudioTierSelectorTooltip: 'Выбор тарифа Google AI для оптимизации интервалов генерации',
    rateLimitModalTitle: 'Достигнут лимит частоты запросов API',
    rateLimitModalDesc: 'Превышен лимит запросов в минуту (IPM / RPM 429). Система автоматически приостановила запросы и повторит попытку после кулдауна.',
    rateLimitCountdownLabel: 'Оставшееся время ожидания',
    rateLimitSecondsUnit: 'сек',
    rateLimitRetryBadge: 'Автоповтор {current} из {max}',
    rateLimitActionWait: 'Продолжить ожидание',
    rateLimitActionCancel: 'Отменить генерацию',
    debugTerminalOpen: 'Открыть терминал диагностики',
    debugTerminalClose: 'Закрыть',
    debugTerminalEyebrow: 'Скрытая диагностическая панель',
    debugTerminalTitle: 'Терминал диагностики',
    debugTerminalDescription:
        'Просматривайте очищенные запросы, ответы, события потока, повторы, пакетные процессы, сохранение рабочего пространства и связанные диагностические данные без раскрытия API-ключей или сырых байтов изображения.',
    debugTerminalEventCount: '{0} событий всего',
    debugTerminalFilteredCount: '{0} видно',
    ...
    debugTerminalEmpty:
        'Диагностических событий пока нет. Запустите генерацию, инструмент prompt, пакетный процесс или действие с рабочим пространством, чтобы начать собирать очищенные трассы.',
    debugTerminalSelectEvent: 'Выберите событие, чтобы просмотреть его очищенный payload.',
    ...
    debugTerminalSourceAll: 'Все источники',
    debugTerminalRouteAll: 'Все маршруты',
    debugTerminalSearchPlaceholder: 'Поиск по маршруту, сводке, статусу, корреляции, payload...',
    debugTerminalFocusCorrelation: 'Фокус на корреляции',
    debugTerminalCorrelationActive: 'Корреляция: {0}',
    debugTerminalSourceGeneration: 'Генерация',
    debugTerminalSourcePromptTools: 'Инструменты prompt',
    debugTerminalSourceBatch: 'Пакет',
    debugTerminalSourceWorkspace: 'Рабочее пространство',
    debugTerminalSourceRuntime: 'Среда выполнения',
    debugTerminalSourceImageFile: 'Изображение/файл',
    debugTerminalSourceBackend: 'Бэкенд',
    debugTerminalSourceWorkflow: 'Рабочий процесс',
    debugTerminalSourceUnknown: 'Неизвестно',
    ...
    workspaceToolbarGroupLabel: 'Пространство',
    workspaceToolbarActionImport: 'Импорт',
    workspaceToolbarActionExport: 'Экспорт',
    workspaceToolbarActionClear: 'Очистить',
    ...
    generationFailureDetailQuota:
        'Запрос ограничен по частоте или ваша квота временно исчерпана. Попробуйте увеличить интервал между запросами или подождать сброса скользящего окна.',
} as const;
