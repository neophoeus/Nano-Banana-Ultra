export const ru = {
    ...
    statusPanelSystem: 'Система',
    statusPanelTitle: 'Панель статуса',
    statusPanelRefresh: 'Обновить статус системы',
    statusPanelLocalApi: 'Локальный API',
    statusPanelGeminiKey: 'Ключ Gemini',
    statusPanelLastCheck: 'Последняя проверка',
    statusPanelChecking: 'Проверка',
    statusPanelPingingRoute: 'Проверка локального маршрута',
    statusPanelOffline: 'Не в сети',
    statusPanelRouteUnavailable: 'Маршрут недоступен',
    statusPanelLive: 'Активен',
    statusPanelApiResponding: 'Локальный API отвечает',
    statusPanelReadingConfig: 'Чтение конфигурации',
    statusPanelReady: 'Готов',
    statusPanelKeyDetected: 'Ключ Gemini найден',
    statusPanelMissing: 'Отсутствует',
    statusPanelSetKey: 'Укажите GEMINI_API_KEY',
    statusPanelExpand: 'Развернуть',
    statusPanelCollapse: 'Свернуть',
    statusPanelNever: 'Никогда',
    statusPanelUnknown: 'Неизвестно',
    ...
    workspaceRestoreActiveBranch: 'активная ветка {0}',
    ...
    workspaceRestoreDismiss: 'Закрыть',
    ...
    sessionReplayErrors: 'Ошибки',
    sessionReplayFocus: 'Фокус повтора',
    sessionReplayPrev: 'Назад',
    sessionReplayNext: 'Далее',
    sessionReplayCurrentStageSource: 'Текущий источник сцены',
    sessionReplayStepCounter: 'Шаг {0} / {1}',
    ...
    sessionReplayNoTimestamp: 'Временная метка не записана',
    ...
    sessionReplayJumpToSource: 'Перейти к событию-источнику',
    sessionReplayJumpToLatest: 'Перейти к последнему',
    sessionReplayNoTime: 'Нет времени',
    sessionReplayLabelSystem: 'Система',
    sessionReplayLabelInput: 'Ввод',
    sessionReplayLabelRequest: 'Запрос',
    sessionReplayLabelProcessing: 'Обработка',
    sessionReplayLabelOutput: 'Вывод',
    sessionReplayLabelHistory: 'История',
    sessionReplayLabelError: 'Ошибка',
    sessionReplayLabelCancelled: 'Отменено',
