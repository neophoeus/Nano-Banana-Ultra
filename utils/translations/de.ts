export const de = {
    ...
    promptThinkingLevel: 'Prompt-Denkstufe',
    promptThinkingLevelLow: 'Niedrig',
    promptThinkingLevelMedium: 'Mittel',
    promptThinkingLevelHigh: 'Hoch',
    promptThinkingLevelLowTooltip: '⚡ Niedrig (Low): Ultraschnelle Antwort, minimaler Token-Verbrauch',
    promptThinkingLevelMediumTooltip: '🧠 Mittel (Med): Standard-Schlussfolgerung, ausgewogene Kreativität',
    promptThinkingLevelHighTooltip: '🔬 Hoch (High): Tiefgehende Detailanalyse',
    ...
    statusPanelGeminiKey: 'API-Schlüssel',
    statusPanelDirectMode: 'AI Studio',
    executionModeTitle: 'Engine-Modus',
    executionModeAuto: 'Automatisch erkennen',
    executionModeLocal: 'Lokale API',
    executionModeDirect: 'AI Studio',
    executionModeSelectorTooltip: 'Engine-Modus umschalten (Automatisch / Lokale API / AI Studio)',
    aiStudioTierTitle: 'Google AI Tarif',
    aiStudioTierPro: 'Google AI Pro (1x)',
    aiStudioTierUltra5x: 'Google AI Ultra (5x)',
    aiStudioTierUltra20x: 'Google AI Ultra (20x)',
    aiStudioTierSelectorTooltip: 'Google AI Tarif für optimiertes Timing auswählen',
    rateLimitModalTitle: 'API-Ratenlimit erreicht',
    rateLimitModalDesc: 'Das Kontingent pro Minute (IPM / RPM 429) wurde erreicht. Das System hat automatisch pausiert und versucht es nach der Abkühlzeit erneut.',
    rateLimitCountdownLabel: 'Verbleibende Wartezeit',
    rateLimitSecondsUnit: 's',
    rateLimitRetryBadge: 'Automatischer Neuversuch {current} von {max}',
    rateLimitActionWait: 'Weiter warten',
    rateLimitActionCancel: 'Generierung abbrechen',
    debugTerminalOpen: 'Diagnose-Terminal öffnen',
    debugTerminalClose: 'Schliessen',
    debugTerminalEyebrow: 'Versteckte Diagnoseoberflaeche',
    debugTerminalTitle: 'Diagnose-Terminal',
    debugTerminalDescription:
        'Pruefe bereinigte Anfragen, Antworten, Stream-Ereignisse, Wiederholungen, Batch-Ablaeufe, Workspace-Speicherungen und korrelierte Diagnosen, ohne API-Schluessel oder rohe Bilddaten offenzulegen.',
    ...
    debugTerminalEmpty:
        'Noch keine Diagnoseereignisse. Fuehre eine Generierung, ein Prompt-Werkzeug, einen Batch-Ablauf oder eine Workspace-Aktion aus, um bereinigte Spuren zu sammeln.',
    ...
    debugTerminalSourceAll: 'Alle Quellen',
    debugTerminalRouteAll: 'Alle Routen',
    debugTerminalSearchPlaceholder: 'Route, Zusammenfassung, Status, Korrelation, Payload suchen...',
    debugTerminalFocusCorrelation: 'Korrelation fokussieren',
    debugTerminalCorrelationActive: 'Korrelation: {0}',
    debugTerminalSourceGeneration: 'Generierung',
    debugTerminalSourcePromptTools: 'Prompt-Werkzeuge',
    debugTerminalSourceBatch: 'Batch',
    debugTerminalSourceWorkspace: 'Arbeitsbereich',
    debugTerminalSourceRuntime: 'Laufzeit',
    debugTerminalSourceImageFile: 'Bild/Datei',
    debugTerminalSourceBackend: 'Backend',
    debugTerminalSourceWorkflow: 'Ablauf',
    debugTerminalSourceUnknown: 'Unbekannt',
    ...
    workspaceToolbarGroupLabel: 'Arbeitsbereich',
    workspaceToolbarActionImport: 'Import',
    workspaceToolbarActionExport: 'Export',
    workspaceToolbarActionClear: 'Leeren',
    ...
    generationFailureDetailQuota:
        'Die Anfrage wurde ratenbegrenzt oder Ihr Kontingent ist vorübergehend erschöpft. Das Vergrößern der Abstände zwischen Anfragen oder Warten auf das Zurücksetzen des Zeitfensters kann helfen.',
} as const;
