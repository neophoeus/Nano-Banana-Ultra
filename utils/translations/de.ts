export const de = {
    ...
    statusPanelTitle: 'Statuspanel',
    statusPanelRefresh: 'Systemstatus aktualisieren',
    statusPanelLocalApi: 'Lokale API',
    statusPanelGeminiKey: 'Gemini-Schlüssel',
    statusPanelLastCheck: 'Letzte Prüfung',
    statusPanelChecking: 'Pruefung laeuft',
    statusPanelPingingRoute: 'Lokale Route wird geprueft',
    statusPanelOffline: 'Offline',
    statusPanelRouteUnavailable: 'Route nicht verfügbar',
    statusPanelLive: 'Aktiv',
    statusPanelApiResponding: 'Lokale API antwortet',
    statusPanelReadingConfig: 'Laufzeitkonfiguration wird gelesen',
    statusPanelReady: 'Bereit',
    statusPanelKeyDetected: 'Gemini-Schlüssel erkannt',
    statusPanelMissing: 'Fehlt',
    statusPanelSetKey: 'GEMINI_API_KEY setzen',
    statusPanelExpand: 'Erweitern',
    statusPanelCollapse: 'Einklappen',
    statusPanelNever: 'Nie',
    statusPanelUnknown: 'Unbekannt',
    ...
    workspaceRestoreBranch: 'Von der Wiederherstellung abzweigen',
    workspaceRestoreUseSettingsClear: 'Einstellungen verwenden, Kette loschen',
    workspaceRestoreDismiss: 'Schliessen',
    ...
    sessionReplayErrors: 'Fehler',
    sessionReplayFocus: 'Wiedergabefokus',
    sessionReplayPrev: 'Zuruck',
    sessionReplayNext: 'Weiter',
    sessionReplayCurrentStageSource: 'Aktuelle Szenenquelle',
    sessionReplayStepCounter: 'Schritt {0} / {1}',
    ...
    sessionReplayNoTimestamp: 'Kein Zeitstempel gespeichert',
    ...
    sessionReplayJumpToSource: 'Zum Quellenereignis springen',
    sessionReplayJumpToLatest: 'Zum neuesten springen',
    sessionReplayNoTime: 'Keine Zeit',
    sessionReplayLabelSystem: 'System',
    sessionReplayLabelInput: 'Eingabe',
    sessionReplayLabelRequest: 'Anfrage',
    sessionReplayLabelProcessing: 'Verarbeitung',
    sessionReplayLabelOutput: 'Ausgabe',
    sessionReplayLabelHistory: 'Verlauf',
    sessionReplayLabelError: 'Fehler',
    sessionReplayLabelCancelled: 'Abgebrochen',
