    ...
    return (
        ...
        >
            <div className="space-y-4 pt-2">
                ...
                <div className="rounded-[24px] border border-gray-200/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.9),rgba(247,250,252,0.9))] p-4 shadow-[0_16px_48px_rgba(15,23,42,0.08)] dark:border-gray-700/80 dark:bg-[linear-gradient(180deg,rgba(23,28,36,0.94),rgba(14,18,24,0.9))] dark:shadow-[0_16px_48px_rgba(0,0,0,0.28)]">
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                        {onOpenLatestTurn && (
                            <button
                                ...
                                className="rounded-full bg-amber-500 px-2.5 py-1 text-[11px] font-semibold text-white hover:bg-amber-600"
                            >
                        ...
                        {onContinueRestoredChain && (
                            <button
                                ...
                                className="rounded-full border border-amber-200 bg-amber-50 px-2.5 py-1 text-[11px] font-semibold text-amber-800 hover:border-amber-300 hover:bg-amber-100 dark:border-amber-500/20 dark:bg-amber-950/20 dark:text-amber-100 dark:hover:border-amber-500/40 dark:hover:bg-amber-950/30"
                            >
